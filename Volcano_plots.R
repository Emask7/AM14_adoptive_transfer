...
# Make plots -------------------------------------------------------------------
  EnhancedVolcano(vpData_PL23, 
                  lab = vpData_PL23$external_gene_name, 
  ...
  EnhancedVolcano(vpData_R848, 
                  lab = vpData_R848$external_gene_name, 
                  pCutoff = 0.05, FCcutoff = 1,
                  x = 'log2FoldChange', y = 'padj', 
                  # xlim = c(-2.5, 1.5), 
                  ylim = c(0, 4),
  ...
  EnhancedVolcano(vpData_PL23vR848, 
                  lab = vpData_PL23vR848$external_gene_name, 
                  pCutoff = 0.05, FCcutoff = 1,
                  x = 'log2FoldChange', y = 'padj', 
                  # xlim = c(-2.5, 1.5), 
                  ylim = c(0, 6),
  ...
  EnhancedVolcano(vpData_2DG_PL23vR848, 
                  lab = vpData_2DG_PL23vR848$external_gene_name, 
                  pCutoff = 0.05, FCcutoff = 1,
                  x = 'log2FoldChange', y = 'padj', 
                  # xlim = c(-2.5, 1.5), 
                  ylim = c(0, 10),
